...
class Scraper:
    ...
    async def scrape_channel(self) -> dict:
        ...
        data = {
                ...
                "category_id": self.__channel.category.id if self.__channel.category is not None else None,
    ...
    def __scrape_embed(embed: discord.Embed) -> dict:
        return {
            ...
            } if embed.footer is not None else None,
    ...
    def __scape_user(self, user: discord.User | discord.Member) -> int:
        if not user.id in self.__users.keys():
            ...
            "avatar": Scraper.__scrape_asset(user.avatar) if user.avatar is not None else None,
